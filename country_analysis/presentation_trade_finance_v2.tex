...
\title{Country Analysis}
\subtitle{Mexico, Peru, Chile, and Brazil}
\author{Eugenia Andreasen, Paula Margaretic, Ean Paredes, Tomás Fernández}
\date{November 2025}
...
% ==============================================================================
% REQUIREMENTS VS COMPLETED ANALYSIS
% ==============================================================================

\begin{frame}{Requirements vs. Completed Analysis - Overview}
\footnotesize

\textbf{Status Legend:} \textcolor{green!60!black}{✓ Complete} | \textcolor{orange!80!black}{⚠ Partial/Issue} | \textcolor{red!80!black}{✗ Missing/Impossible}
...
\begin{tabular}{lcccc}
\toprule
\textbf{Country} & \textbf{Required} & \textbf{Completed} & \textbf{Additional} & \textbf{Status} \\
\midrule
Mexico  & 2 & 2 & +4 & \textcolor{green!60!black}{✓✓} \\
Peru    & 4 & 4 & +3 & \textcolor{green!60!black}{✓✓✓✓} \\
Chile   & 6 & 5.5 & +3 & \textcolor{orange!80!black}{⚠} (CHL-6) \\
Brazil  & 4 & 2 & +6 & \textcolor{orange!80!black}{⚠} (2 impossible) \\
\midrule
\textbf{Total} & \textbf{16} & \textbf{13.5/16} & \textbf{+16} & \textbf{30 graphs} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Key Issues:}
\begin{itemize}
    \item \textcolor{orange!80!black}{Chile CHL-6:} Currently uses \texttt{chl\_02} (TF by banks) instead of \texttt{chl\_07} (L/C by banks) - duplicates CHL-2
    \item \textcolor{red!80!black}{Brazil bank graphs:} No bank-level data available in public SCR; generated regional alternatives instead
\end{itemize}

\end{frame}

\begin{frame}{Requirements vs. Completed - Detailed Comparison}
\tiny

\textbf{MEXICO} \textcolor{green!60!black}{[2/2 required ✓]} + 4 additional

\begin{itemize}
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} L/C as \% of total liabilities → \textbf{MEX-2} ✓
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} L/C by type of bank (Foreign/Domestic) → \textbf{MEX-3} ✓
    \item \textbf{Additional:} MEX-1 (L/C monthly volume), MEX-4 (L/C \% exports), MEX-5 (L/C \% trade), MEX-6 (L/C top 5 banks)
\end{itemize}

\vspace{0.15cm}

\textbf{PERU} \textcolor{green!60!black}{[4/4 required ✓]} + 3 additional

\begin{itemize}
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} TF as \% of total credit → \textbf{PER-1} ✓
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} TF by borrower size → \textbf{PER-2} ✓
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} TF by type of bank → \textbf{PER-3} ✓
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} Market concentration (HHI + top banks) → \textbf{PER-4} ✓
    \item \textbf{Additional:} PER-5 (TF \% exports), PER-6 (TF \% trade), PER-7 (TF top 5 banks)
\end{itemize}

\vspace{0.15cm}

\textbf{CHILE} \textcolor{orange!80!black}{[5.5/6 required ⚠]} + 3 additional

\begin{itemize}
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} TF as \% of total loans → \textbf{CHL-1} ✓
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} TF by type of bank → \textbf{CHL-2} ✓
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} Market concentration (HHI) → \textbf{CHL-3} ✓
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} Interbank foreign funding → \textbf{CHL-4} ✓
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} L/C as \% of liabilities (comparable to Mexico) → \textbf{CHL-5} ✓
    \item[\textcolor{orange!80!black}{⚠}] \textbf{Required:} L/C by type of bank → \textbf{CHL-6 ERROR:} uses \texttt{chl\_02} (duplicates CHL-2), should use \texttt{chl\_07}
    \item \textbf{Additional:} CHL-5b (L/C monthly), CHL-7 (TF \% exports), CHL-8 (TF \% trade), CHL-9 (TF composition)
\end{itemize}

\vspace{0.15cm}

\textbf{BRAZIL} \textcolor{orange!80!black}{[2/4 required]} + 6 additional (\textcolor{red!80!black}{2 impossible due to data limitations})

\begin{itemize}
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} TF as \% of total credit → \textbf{BRA-1} ✓
    \item[\textcolor{green!60!black}{✓}] \textbf{Required:} TF by borrower size (comparable to Peru) → \textbf{BRA-2} ✓
    \item[\textcolor{red!80!black}{✗}] \textbf{Required:} TF by type of bank → \textcolor{red!80!black}{IMPOSSIBLE:} No bank identifiers in BCB public data
    \item[\textcolor{red!80!black}{✗}] \textbf{Required:} Market concentration → \textcolor{red!80!black}{IMPOSSIBLE:} No bank identifiers in BCB public data
    \item \textbf{Additional:} BRA-3 (TF by region), BRA-4 (regional concentration), BRA-5 (size distribution Peru-comparable), BRA-6 (TF \% exports), BRA-7 (TF \% trade), BRA-8 (TF by sector)
\end{itemize}
...
\textbf{Coverage:}
\begin{itemize}
    \item Account 202401504003: Import Letters of Credit 
...
\begin{itemize}
    ...
    \item Borrower characteristics: firm size, region
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Accounting systems:} Chile 2022 break, revisar.
\end{itemize}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{Presentations/Plots and tables/country_analysis/mexico/mex_01_lc_monthly.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.7\textwidth]{Presentations/Plots and tables/country_analysis/mexico/mex_02_lc_pct_liabilities.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.57\textwidth]{Presentations/Plots and tables/country_analysis/mexico/mex_03_lc_by_bank_type.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.657\textwidth]{Presentations/Plots and tables/country_analysis/mexico/mex_04_lc_pct_exports.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.57\textwidth]{Presentations/Plots and tables/country_analysis/mexico/mex_05_lc_pct_trade.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.57\textwidth]{Presentations/Plots and tables/country_analysis/mexico/mex_06_lc_top5_banks.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.647\textwidth]{Presentations/Plots and tables/country_analysis/peru/per_01_tf_pct_total.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.647\textwidth]{Presentations/Plots and tables/country_analysis/peru/per_02_tf_by_size.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/peru/per_03_tf_by_bank_type.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/peru/per_04_concentration.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/peru/per_05_tf_pct_exports.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/peru/per_06_tf_pct_trade.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/peru/per_07_tf_top5_banks.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/chile/chl_01_tf_pct_loans.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/chile/chl_02_tf_top5_banks.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/chile/chl_03_concentration.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/chile/chl_04_foreign_funding.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/chile/chl_06_lc_pct_liabilities.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{frame}{CHL-5b: Letters of Credit monthly}
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/chile/chl_05_lc_monthly.png}
\end{center}
\vspace{-0.3cm}
\small
\textbf{Description:} Outstanding L/C in USD millions. Monthly 2022-2024.
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/chile/chl_08_tf_pct_exports.png}
\end{center}
\vspace{-0.3cm}
\small
\textbf{Description:} Monthly TF stock as percentage of annual exports. Methodology: monthly stock / annual exports × 100.
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/chile/chl_09_tf_pct_trade.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/chile/chl_10_tf_composition.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.637\textwidth]{Presentations/Plots and tables/country_analysis/brazil/bra_01_tf_pct_total.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.637\textwidth]{Presentations/Plots and tables/country_analysis/brazil/bra_02_tf_by_size.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.637\textwidth]{Presentations/Plots and tables/country_analysis/brazil/bra_03_tf_by_region.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/brazil/bra_04_regional_concentration.png}
\end{center}
\vspace{-0.3cm}
\small
...
\begin{frame}{BRA-5: TF Distribution by Borrower Size}
\begin{center}
\includegraphics[width=0.627\textwidth]{Presentations/Plots and tables/country_analysis/brazil/bra_05_size_comparison.png}
\end{center}
\vspace{-0.3cm}
\small
\textbf{Description:} Grouped bars showing TF borrower size distribution. 2023-2024 average.

\vspace{0.2cm}
\textbf{Source:} BCB Monthly Reports

\vspace{0.2cm}
\textbf{Notes:} Médio: 54\% by operation count. Grande: 80\% by volume.
\end{frame}

\begin{frame}{BRA-6: TF as \% of Annual Exports}
\begin{center}
\includegraphics[width=0.5627\textwidth]{Presentations/Plots and tables/country_analysis/brazil/bra_06_tf_pct_exports.png}
\end{center}
\vspace{-0.3cm}
\small
\textbf{Description:} Monthly TF stock as percentage of annual exports. Methodology: monthly stock / annual exports × 100.
...
\vspace{0.2cm}
\textbf{Notes:} Range: 10.3\%-23.7\%. Me llamó la atención y es que aumentan mucho las exportaciones en el último periodo.
\end{frame}

\begin{frame}{BRA-7: TF as \% of Annual Total Trade}
\begin{center}
\includegraphics[width=0.57\textwidth]{Presentations/Plots and tables/country_analysis/brazil/bra_07_tf_pct_trade.png}
\end{center}
\vspace{-0.3cm}
\small
\textbf{Description:} Monthly TF stock as percentage of annual total trade. Methodology: monthly stock / annual (X+M) × 100.
...
\begin{center}
\includegraphics[width=0.637\textwidth]{Presentations/Plots and tables/country_analysis/brazil/bra_08_tf_by_sector.png}
\end{center}
\vspace{-0.3cm}
\small
